...
```{r}
colnames(gp2007)
ggplot(gp2007, aes(x = gdpPercap)) + geom_histogram() + facet_wrap(~ continent) 
```
```{r}
mutate(gp2007, pop_grp = cut(pop, breaks = quantile(pop, c(0.25, 0.5, 0.75, 1)))) |>
